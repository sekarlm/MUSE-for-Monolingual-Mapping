...
DUMP_PATH = 'dumped/debug/hjhen8o9pr/'
...
# python3 eval_monolingual_mapping.py jvsu.mbert.txt jv-su-test.txt non-1-wrong-trans.txt non-1-correct-trans.txt
